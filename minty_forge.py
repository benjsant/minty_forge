    ...
    while True:
        ...
        if key == curses.KEY_UP and current_row > 0:
            ...
            if current_row == len(MENU_OPTIONS) - 1:  # Exit
                ...
                stdscr.refresh()
                match current_row:
                    case 0: run_script("apt_install.py")
                    case 1: run_script("apt_remove.py")
                    case 2: run_script("flatpak_install.py")
                    case 3: run_script("themes_install.py")
                    case 4: run_script("drivers.py")
                    case 5: run_script("qt_install.py")
                    case 6: run_script("distroscript_install.py")
